              ...
              >
                ...
                <div className="flex items-start justify-between mb-4 relative z-10">
                  ...
                  <svg className="w-8 h-8 text-slate-400 group-hover:text-slate-800 dark:group-hover:text-white transition-colors flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-[10px] font-bold tracking-widest uppercase text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 px-3 py-1.5 rounded-md shadow-sm border border-emerald-500/20 flex-shrink-0">
                      即点即玩
                    </span>
                  )}
                </div>
